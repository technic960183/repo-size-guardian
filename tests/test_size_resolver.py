...
class TestGetBlobSizesBatch(GitRepoTestBase):
    ...
    def test_get_blob_sizes_batch_duplicate_blobs(self):
...
class TestAugmentBlobObjectsWithSizes(GitRepoTestBase):
    ...
    def test_augment_blob_objects_with_sizes_multiple_blobs(self):
    ...
    def test_augment_blob_objects_with_sizes_deleted_file(self):
